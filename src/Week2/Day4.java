...
public class Day4 {
    ...
    public static void prefixOperator(){
        ...
        while (myNumber < myArray.length - 1) {
            //this does increment myNumber, so this is not an infite loop
            //throws an exception if not careful
            System.out.println(myArray[++myNumber]);
            //if the operator is outside another method call
    ...
    public static void postfixOperator() {
        //postfix operator is variable ++ or variable --
        ...
        while (myNumber < myArray.length) {
            ...
            System.out.print(myArray[myNumber++]);
        }
