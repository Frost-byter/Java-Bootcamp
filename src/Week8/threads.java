...
////
////        ThreadSum t1 = new ThreadSum(() -> System.out.println("this is a thread1"));
////        ThreadSum t2 = new ThreadSum(() -> System.out.println("this is a thread2"));
////
////        //try {
...
//////        ThreadSum t3 = new ThreadSum(new Runnable() {
//////            @Override
//////            public void run() {
