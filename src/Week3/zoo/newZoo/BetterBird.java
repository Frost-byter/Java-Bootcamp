...
//******Step 3****** Define child classes
public class BetterBird extends newAnimal {
    ...
    //final methods are still inherited and work exactly the same as non-final methods.
    //Except final methods cannot be overridden
