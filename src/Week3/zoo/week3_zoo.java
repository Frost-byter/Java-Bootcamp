...
import Week3.zoo.Bird.Beans.*;

public class week3_zoo {

    // properties create a HAS-A relationship
    // a Week3_Zoo HAS-A name
    // a Week3_Zoo HAS-A address
    // a Week3_Zoo HAS-A masterZoologist
    ...
    // this will be our week 3 Week3_Zoo
    ...
    public static void main(String[] args) {
        ...
        buyTickets(4);
        week3_zoo.buyTickets(3);

        // cannot do the same thing for instance methods
        // cannot directly call non-static methods from inside a static method
        //sellPopcorn();
        // this is a call to our Week3_Zoo constructor
        week3_zoo phillyWeek3_Zoo = new week3_zoo();
        // with an instance of a class, you can call instance methods
        phillyWeek3_Zoo.sellPopcorn();

        week3_zoo nyWeek3_Zoo = new week3_zoo();
        nyWeek3_Zoo.sellPopcorn();

        // static variables can be called just like methods
        // static variables are shared across all instances
        System.out.println(masterZoologist); // only works in my Week3_Zoo class
        System.out.println(week3_zoo.masterZoologist); // the proper way to call this
        // this property does not belong to the instance, so it doesnt like
        // me accessing it this way
        System.out.println(phillyWeek3_Zoo.masterZoologist);
        System.out.println(nyWeek3_Zoo.masterZoologist);

        phillyWeek3_Zoo.masterZoologist = "Dr. Anthony";
        System.out.println(phillyWeek3_Zoo.masterZoologist);
        System.out.println(nyWeek3_Zoo.masterZoologist);
        System.out.println(masterZoologist); // only works in my Week3_Zoo class
        System.out.println(week3_zoo.masterZoologist); // the proper way to call this

        phillyWeek3_Zoo.name = "Philadelphia Week3_Zoo";
        nyWeek3_Zoo.name = "New York Week3_Zoo";

        System.out.println(phillyWeek3_Zoo.name);
        System.out.println(nyWeek3_Zoo.name);
    ...
    public void birdExhibit() {
        ...
        // it sees these methods exist in the parent class, and not the child
...
//				temp.dance();
    ...
    // this method is an instance method, it exists on an instance of a Week3_Zoo
