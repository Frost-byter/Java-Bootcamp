package Week3.zoo.Abstraction;

import Week3.zoo.Animal;
...
public class Zoo {
    ...
    public void sharkExhibit() {
        ...
        // the compiler doesn't pre-check cast, it runs it and finds out if it works or not during runtime
        //this cast will cail when it runs because a hammerhead is not a goblin
        //but both are sharks
