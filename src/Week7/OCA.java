...
//        interfaces();
    ...
    public static void sorting(){
       ...
       nums = new int[] {7,12,22,43,1,2,45,62,3,29,77,32};
        mysort.print(nums);
        mysort.bubblesort(nums);
...
//        //recursive.recursion(); // stack overflow
//
//        System.out.println("*****Recursive********");
//        System.out.println(recursive.sum(20));
//        System.out.println(recursive.sum(70));
//        System.out.println(recursive.sum(90));
//
//        for (int i =0; i <50; i++){
//            System.out.print(recursive.fibonnaci(i) + " ");
//        }
//        System.out.println();
//
//        System.out.println("\n*****Iterative********");
//        System.out.println(recursive.iterativeSum(20));
//        System.out.println(recursive.iterativeSum(70));
//        System.out.println(recursive.iterativeSum(90));
//
//        for (int i =0; i <50; i++){
//            System.out.print(recursive.iterativeFibonnaci(i) + " ");
//        }
//    }
