...
public class Sedan extends Vehicle implements Comparable<Sedan> { // replace T with the class name
    ...
    //Hashcode = a unique code that represents the instance of an object
    //if the equals method says two objects are equal then the hashcode method
    //should say the same thing
//    @Override
//    public int Hashcode(){
//        //Java gives us a built in way to get a hashcode from our properties
//        //we'll use make and model here cause these are the properties we compared
//        //in our equals method
//        return Objects.hash(getMake(), getModel());
//    }


    //When you override the equals method, you also need to override the hascode method
    ...
    public static class SedanColorComparator2 implements Comparator<Sedan> {
        ...
        @Override
        public Comparator<Sedan> reversed() {
