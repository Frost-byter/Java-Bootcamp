...
import Week5.Sedan;
import Week5.Sedan.SedanColorComparator;
import Week5.Sedan.SedanColorComparator2;
...
public class Foundation {
    ...
    public static void sets(){
        ...
        System.out.println(names.contains("Drew"));

        //can loop of a HashSet, but cannot access a specific element
        for(String name: names){
            System.out.println(name);
        }
        //Iterator, a special class that represents an unchanging set of values
        //that I can loop over
        ...
        while(hashSetIterator.hasNext()){
            ...
            //next() will throw an exception if there is no value to grab
            String name = hashSetIterator.next();
            System.out.println(name);

            //both of the loops above are exactly the same
        }
        ...
        //map is an interface just like list, queue, and dequeue(stack)
            ...
            birthdays.put("Drews", "05091995");
            birthdays.put("Shelby's", "03262003");

            //sorts / finds your keys based on their hashcode
            System.out.println(birthdays);

            //much like a list's get, where you search off the index. You can
        //search a hashmap by key
            System.out.println(birthdays.get("Drew"));

            //can use a loop to print everything in a mps entryset
        ...
        //this will return null if nothing is there
            System.out.println(birthdays.get("Shelby"));
            System.out.println(birthdays.size());

         // i can change the values in a map
        // I can change the value in a map
            birthdays.replace("Drew", "05091995");
            System.out.println(birthdays);

            //can update values but not keys
            //does nothing if the key is not present
        //put overwrites what is there if the key already exist, else it adds it
            birthdays.put("Shelby", "03262003");
            System.out.println(birthdays);

            birthdays.remove("homie");
            System.out.println(birthdays);
            //map allows duplicates, they just overwrite what was previously there
        }
